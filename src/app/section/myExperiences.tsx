          ...
          >
            ...
            >
              ...
              <motion.a
                ...
                target="_blank"
                className={`company relative font-shantell font-semibold cursor-pointer rounded-xl p-1 px-2 md:px-4 md:p-0 text-[18px] md:text-[35px] lg:text-[40] inline-block border-[0.5px] ${exp.bgClass} ${exp.textClass}`}
                href={exp.url}
              >
                {" "}
                {exp.company}
